...
void set_relay1(uint8_t state) {
    WRITE_BIT(DDR_RELAY, RELAY_CONTROL_1, state);
}

void set_relay2(uint8_t state) {
    WRITE_BIT(DDR_RELAY, RELAY_CONTROL_2, state);
}

void set_relay3(uint8_t state) {
    WRITE_BIT(DDR_RELAY, RELAY_CONTROL_3, state);
}

void set_relay4(uint8_t state) {
    WRITE_BIT(DDR_RELAY, RELAY_CONTROL_4, state);
}
